...
public class Main {
	...
	public static void main(String[] args) {
		if (args.length ==1) {
			...
			System.exit(1);
			// 0 Signifie que l'execution s'est bien passé; 1/2/3/4 seraient des erreurs -1 = plantage technique
			// return; possible d'écrire ça aussi
			// entre chevron c'est obligatoire, entre crochet aurait été optionnel
		}
